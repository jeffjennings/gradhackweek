...
fns = ['planets_obs.txt', 'WD_Number_Density.csv', 'NS_Number_Density.csv', \
       'MADE_dNdVdlogM_M.csv', 'imf_dNdVdlogM_M.csv', \
...
cuts = [0, 0, 0, 0, 0, 0, 1e7, 0, 1e7, 2e7, 2.3e6, 1e7, 1e6, 0, 1.2e10, 1.5e9, 3e8, 3e7, 0] # completeness cuts in x-range

pwrs = [False, False, False, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True] # if the mass is given as 'pwr' in 10**pwr

labs = ['Planets', 'White dwarfs', 'Neutron stars', 'Stars, obs.', 'Stars, IMF', \
        'Dwarf galaxies', 'Galaxies, SDSS', 'SDSS, Thanjavur+2016', \
...
for i in range(len(fns)):
    ...
    plot_hist(ax1, fns, cuts, cs, lss, labs, pwrs)
